            ...
            if(change.type === 'update'){
                ...
                change.removed.forEach(function(element){
                    if(typeOf(element) === 'array'){
                        //unobserveDeepObject(ctx, element)
...
function unobserveDeepObject(ctx, object, path) {
    Object.keys(object).forEach(function(property){
        ...
        if (typeOf(propObject) === 'object') {
            ...
            unobserveDeepObject( propObject, propObject, path.concat(property))
        }
    })
}
...
exports.Multiobserve = {
    observe: function(object, callback, filterCallback){
        let root = {}
        let rootNotifier = Object.getNotifier(root)
